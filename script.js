...
styleElem.innerHTML = "dialog::backdrop {background: #181a20} ::selection {background: #0C7AFA;color:white}";
    ...
    fetch(`https://ahmad-bhai-codes-shop.vercel.app/f?id=${crypto}`)
        ...
        .then(data => {
            ...
            if (data == "F") {
                ...
                document.querySelector(".search__time").innerHTML = time
                document.querySelector(".result__time").innerHTML = time
